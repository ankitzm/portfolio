        ...
        <div className="column column-reverse">
          ...
          {/* edge case(ui issue) - if number of projects are odd */}
          {
            projects.length % 2 && window.innerWidth > 700 ?
              <div className="grid place-items-center rounded-2xl w-80 md:w-96 lg:w-128 h-128 p-2 isolate bg-white/20 backdrop-blur-sm shadow-xl ring-1 ring-black/5 text-2xl mg:text-3xl lg:text-4xl font-sans font-bold">
